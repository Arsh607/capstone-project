...
function ProductDetails() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "grey", color: "white", padding: "30px" }}>
      ...
      <form onSubmit={handleUpdate} style={{ marginTop: "25px", display: "grid", gap: "12px", width: "350px" }}>
        ...
        <input value={formData.supplierId} onChange={(e) => setFormData({ ...formData, supplierId: e.target.value })} />

        <button type="submit">Update Product</button>
      </form>

      <button onClick={handleDelete} style={{ marginTop: "50px", background: "red" }}>
        Delete Product
      </button>
    </main>
  );
